...
/**
 * Runtime model generated from blockbench/desert_hare.bbmodel.
 *
 * The Blockbench file remains the editable geometry source. Animation definitions
 * live in DesertHareAnimations and are applied to these named bones.
 */
public final class DesertHareModel extends HierarchicalModel<DesertHareEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(MinecraftDune.MOD_ID, "desert_hare"),
            "main"
    );
    ...
    public DesertHareModel(ModelPart bakedRoot) {
    ...
    public void setupAnim(
        ...
        animate(entity.sniffAnimationState, DesertHareAnimations.SNIFF_GROUND, ageInTicks);
        animate(entity.wiggleHeadAnimationState, DesertHareAnimations.WIGGLE_HEAD, ageInTicks);
